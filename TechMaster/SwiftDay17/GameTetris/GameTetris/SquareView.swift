...
//            squareLayer.path = UIBezierPath(ovalIn: CGRect(x: 0.0, y: 0.0, width: self.frame.size.width, height: self.frame.size.height)).cgPath
...
//            topLayer.strokeColor = UIColor.green.cgColor
