...
class ViewController: UIViewController {
    ...
    let collectionView : UICollectionView = {
        ...
        let conectionView = UICollectionView(frame: CGRect.zero, collectionViewLayout: layout)
        conectionView.translatesAutoresizingMaskIntoConstraints = false
        conectionView.register(MyCollectionViewCell.self, forCellWithReuseIdentifier: "cell")
        return conectionView
    }()
